...
public class VerhoogdeNoteMarker extends NoteMarker{
    public VerhoogdeNoteMarker(Canvas canvas, int noteCircleSize, int smallNoteCircleSize, double[][] positionsOfNotes, double keyWidth) {
